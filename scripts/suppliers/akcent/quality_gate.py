...
v26:
- исправляет совместимость с current build_akcent.py;
- run_quality_gate принимает legacy-аргументы max_new_cosmetic_offers/max_new_cosmetic_issues;
- _write_report вызывает общий cs.qg_report.write_quality_gate_report по новому интерфейсу.
