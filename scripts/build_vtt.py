...
def main() -> int:
    ...
    write_cs_feed_raw(offers, supplier=SUPPLIER, supplier_url=cfg.start_url, out_file="docs/raw/vtt.yml", build_time=now, next_run=next_run, before=len(offers), encoding="utf-8", currency_id="KZT")
