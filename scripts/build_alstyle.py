...
# -*- coding: utf-8 -*-
"""
AlStyle → YML (NO-DESCRIPTION-TOUCH edition)# scripts/build_alstyle.py
# -*- coding: utf-8 -*-
"""
...
def _v34_then_v36() -> None:
    try:
        ...
        if xml3 != xml:
            ...
            # Ensure the static SEO block is injected AFTER v34+v36 re-rendering
            try:
                _inject_seo_block_into_yml(_out)
            except Exception as _e2:
                print("[SEO-INJECT] WARN inline:", _e2)
...
_SEO_HTML_BLOCK = """<a href="https://api.whatsapp.com/send/?phone=77073270501&text=&type=phone_number&app_absent=0" style="display:inline-block;background:#27ae60;color:#ffffff;text-decoration:none;padding:10px 20px;border-radius:10px;font-weight:700;">
...
def _inject_seo_block_into_yml(yml_path: str) -> None:
    try:
        ...
        pattern = re.compile(r'(<description\b[^>]*>\s*<!\[CDATA\[)(.*?)(\]\]>\s*</description>)', re.DOTALL | re.IGNORECASE)
