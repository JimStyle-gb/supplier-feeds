...
jobs:
  build:
    ...
    env:
      ...
      PIP_PACKAGES: "requests beautifulsoup4 openpyxl"
    ...
    steps:
      ...
      - name: Build + commit + push docs/copyline.yml (no conflicts)
        ...
        run: |
          ...
          for attempt in 1 2 3; do
            ...
            git commit -m "chore(copyline): update docs/copyline.yml [skip ci]"
