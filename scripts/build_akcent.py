...
def _filter_params(body: str) -> str:
    ...
    blacklist = [
        ...
        "Наименование производителя",  # дубль имени с кучей кодов, мусор
        "Сопутствующие товары",   # уже перенесли в описание, Param больше не нужен
        "Совместимые продукты",   # список артикулов, для покупателя бесполезен
        "Вид",                    # дублирует «Тип» (шредеры офисные, картриджи и т.п.)
    ]
