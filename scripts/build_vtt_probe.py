...
v3:
- prefix-first probe;
- categories only for diagnostics;
- restricted crawl to /catalog;
- workflow still should not die on ordinary login/probe failures.
"""
...
BUILD_VTT_VERSION = "build_vtt_probe_v3"
